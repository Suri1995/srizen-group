...
export const galleryImages = [
  ...
  {
    category: "Exteriors",
    src: "/gallery/west-facing-villas-wide-angle.webp",
    alt: "Wide angle view of west facing villas",
    span: "col-span-2 row-span-1",
  },
  {
    category: "Exteriors",
    src: "/gallery/east-facing-villa-wide-angle.webp",
  ...
  {
    category: "Clubhouse",
    src: "/gallery/clubhouse-lounge.webp",
    alt: "Clubhouse lounge interior",
    span: "col-span-1 row-span-1",
  },
  {
    category: "Amenities",
    src: "/gallery/indoor-gym.webp",
  ...
  {
    category: "Clubhouse",
    src: "/gallery/banquet-hall.webp",
    alt: "Banquet hall for events and gatherings",
    span: "col-span-2 row-span-1",
  },
  {
    category: "Amenities",
    src: "/gallery/kids-play-area-indoor.webp",
    alt: "Indoor kids play area",
    span: "col-span-1 row-span-1",
  },
  {
    category: "Amenities",
    src: "/gallery/pool-area.webp",
    alt: "Main swimming pool area",
    span: "col-span-2 row-span-2",
  },
  {
    category: "Amenities",
    src: "/gallery/pool-area-02.webp",
    alt: "Swimming pool deck, alternate view",
    span: "col-span-1 row-span-1",
  },
  {
    category: "Amenities",
    src: "/gallery/multipurpose-court.webp",
    alt: "Multipurpose sports court",
    span: "col-span-1 row-span-1",
  },
  {
    category: "Amenities",
    src: "/gallery/multipurpose-court-02.webp",
    alt: "Multipurpose sports court, alternate view",
    span: "col-span-1 row-span-1",
  },
  {
    category: "Amenities",
    src: "/gallery/skating-rink.webp",
    alt: "Skating rink",
    span: "col-span-2 row-span-1",
  },
  {
    category: "Amenities",
    src: "/gallery/yoga-deck.webp",
    alt: "Outdoor yoga and meditation deck",
    span: "col-span-1 row-span-1",
  },
  {
    category: "Amenities",
    src: "/gallery/senior-citizen-sitout.webp",
    alt: "Senior citizen seating plaza with pergola",
    span: "col-span-1 row-span-1",
  },
  {
    category: "Clubhouse",
    src: "/gallery/open-amphitheatre.webp",
    alt: "Open amphitheatre and stage area",
    span: "col-span-2 row-span-1",
  },
  {
    category: "Amenities",
    src: "/gallery/kids-play-area-outdoor.webp",
    alt: "Outdoor kids play area",
    span: "col-span-1 row-span-1",
  },
  {
    category: "Amenities",
    src: "/gallery/outdoor-gym.webp",
    alt: "Outdoor gym",
    span: "col-span-1 row-span-1",
  },
] as const;